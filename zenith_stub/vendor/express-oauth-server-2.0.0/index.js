...
var InvalidArgumentError = require('../node-oauth2-server-4.0.0-dev.2/lib/errors/invalid-argument-error');
var NodeOAuthServer = require('../node-oauth2-server-4.0.0-dev.2');
var Promise = require('bluebird');
var Request = require('../node-oauth2-server-4.0.0-dev.2').Request;
var Response = require('../node-oauth2-server-4.0.0-dev.2').Response;
var UnauthorizedRequestError = require('../node-oauth2-server-4.0.0-dev.2/lib/errors/unauthorized-request-error');
